          ...
          <div class="card-header">
            <div class="row">
              <div class="col-sm-10">
                ...
                <a type="button" onclick=" listarCompromisoAll();" class="btn btn-link btn-sm"> All Compromisos </a> 
                <a type="button" onclick="CargaPlantilla('view/mntcompromiso/','content-wp')" class="btn btn-link btn-sm">Compromisos Cercanos</a> 
                <a type="button" onclick="historial_compromiso();" class="btn btn-link btn-sm">historial de Compromiso</a> 
