...
<a href="#" class="brand-link nav-link active" onclick="CargaPlantilla('view/home/','content-wp')">
  ...
  <a id="Dispositivos-link" class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
  ...
  <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
    ...
    <li class="nav-item">
      <a href="#" class="nav-link dl" onclick="CargaPlantilla('view/mntrouter/','content-wp')">
        Routers
      </a>
    </li>
    <li class="nav-item">
      <a href="#" class="nav-link dl" onclick="CargaPlantilla('view/mntdeco/','content-wp')">
        Decodificador
      </a>
    </li>
    <li class="nav-item">
