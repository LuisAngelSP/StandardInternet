                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" id="cli_dni" name="cli_dni" placeholder="N°DNI">
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                <label>cliente11</label>
                                <input type="text" id="cliente11"  name="cliente11" class="form-control" placeholder=" ">
                                </div>
