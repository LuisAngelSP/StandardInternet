...
(function (l) {
  ...
  function Kb(a) {
    ...
    // Agregar el atajo de teclado de Alt + B al texto del campo de búsqueda


    b = $('<div/>', {
        id: h.f ? null : c + "_filter",
        class: b.sFilter,
    }).append($('<label/>').append(g));
    ...
    $(a.nTable).on("search.dt.DT", function (n, p) {
        if (a === p)
            try {
                m[0] !== document.activeElement && m.val(e.sSearch);
            } catch (t) {}
    });

    // Agregar la funcionalidad del atajo de teclado
